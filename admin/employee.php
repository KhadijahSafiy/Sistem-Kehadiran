	...
	<body>
		...
		<div class="container-fluid admin" >
			...
			<div class="well col-lg-12">
				<button class="btn btn-success" type="button" id="new_emp_btn"><span class="fa fa-plus"></span> Tambah Kakitangan </button>
				<br />
				<br />
	...
	<script type="text/javascript">
		$(document).ready(function(){
				...
				$.ajax({
					...
					success:function(resp){
						if(typeof resp !=undefined){
							...
							$('#new_employee .modal-title').html('Sunting Kakitangan')
			...
			$('#new_emp_btn').click(function(){
				...
				$('[name="jabatan"]').val('')
				$('[name="jawatan"]').val('')
				$('#new_employee .modal-title').html('Tambah Kakitangan')
				$('#new_employee').modal('show')
			})
		});
	</script>
