	...
	<body>
		...
		<div class="container-fluid admin" >
				...
				<div class="modal-dialog" role="document">
					<div class="modal-content ">
						<div class="modal-body">
							<center><label class="text-danger">Padam Data Dengan Segera?</label></center>
							<br />
			...
			<div class="well col-lg-12">
				<button type="button" class="btn btn-primary btn-sm" id="new_user"><i class="fa fa-plus"></i> Tambah Admin</button>
				<br />
				<br />
	...
	<script type="text/javascript">
		$(document).ready(function(){
			...
			$('.remove_user').click(function(){
				...
				var _conf = confirm("Padam Data Dengan Segera?");
				if(_conf == true){
					$.ajax({
				...
				$.ajax({
					...
					success:function(resp){
						if(typeof resp !=undefined){
							...
							$('#manage_user .modal-title').html('Sunting Admin')
			...
			$('#new_user').click(function(){
				...
				$('#manage_user .modal-title').html('Tambah Admin')
				$('#manage_user').modal('show')
			})
		});
	</script>
