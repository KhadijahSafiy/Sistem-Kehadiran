								...
								<div class="text-center mb-4" id="log_display"></div>
									<form action="" id="att-log-frm" >
										<div class="form-group">
											<label for="eno" class="control-label">Kad Pengenalan</label>
											<input type="text" id="kad_pengenalan" name="kad_pengenalan" class="form-control col-sm-12">
										</div>
										<div class="form-group">
											<label for="eno" class="control-label">Kata Laluan</label>
											<input type="text" id="kata_laluan" name="kata_laluan" class="form-control col-sm-12">
										</div>
										<center>
				...
				$(this).click(function(){
					...
					if(a == ''){
						...
						$.ajax({
							...
							method:'POST',
							data:{type:_this.attr('data-id'),a:$('[name="kad_pengenalan"]').val(),b:$('[name="kata_laluan"]').val()},
